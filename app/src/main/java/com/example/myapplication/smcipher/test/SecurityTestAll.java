package com.example.myapplication.smcipher.test;

import com.example.myapplication.smcipher.Util;
import com.example.myapplication.smcipher.sm2.*;
...
//        System.out.println("私钥:" + sm2KeyVO.getPriHexInSoft());
       ...
       final String privateKey = "53cb2ba32c6e8389709ab7b3db297f7374075214d303bd48a1e7457faf1dfc0c";
       final String publicKey = "043d6a94d8bf6ecba363e0cee4302d372ddf3737bfc2cb6b4afb761463dcecbcae949999db1cbc1d7c903fbb2a52d49a4915bd6e3c57efce5bec65100d90c557cf";
...
//        String SM2Enc = SM2Enc(sm2KeyVO.getPubHexInSoft(), src);
        String SM2Enc = SM2Enc(publicKey, src);
        System.out.println("加密:");
        System.out.println("密文:" + SM2Enc);
        String SM2Dec = SM2Dec(privateKey, SM2Enc);
        ...
        SM2SignVO sign = genSM2Signature(privateKey, s5);
        ...
        System.out.println("\n"+publicKey+"\n");
        System.out.println("\n"+s5+"\n");
        System.out.println("\n"+sign.getSm2_signForSoft()+"\n");
        String s6=Util.byteToHex("male".getBytes());
//        boolean b = verifySM2Signature("043d6a94d8bf6ecba363e0cee4302d372ddf3737bfc2cb6b4afb761463dcecbcae949999db1cbc1d7c903fbb2a52d49a4915bd6e3c57efce5bec65100d90c557cf", "6d616c65", "3046022100dd1266a859d81621526f17e18093d01d5dfdb37c68d32d3d4f316fe594623d7c022100fb698af554d85e9308e6fd0bf811500b60878a59656a6f3edb2ab340565c7186");
        boolean b = verifySM2Signature(publicKey, s5, sign.getSm2_signForSoft());

//        boolean c = SM2test.verifySM2Signature(publicKey, Util.byteToHex(signvalue.getBytes()), sign);
        ...
        b = verifySM2Signature(publicKey, s5, SM2SignHardToSoft(sign.getSm2_signForHard()));
